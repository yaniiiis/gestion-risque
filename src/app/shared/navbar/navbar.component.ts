...
import { ROUTES } from 'src/app/admin/components/sidebar/sidebar.component';
...
export class NavbarComponent implements OnInit {
    ...
    constructor(location: Location, private renderer: Renderer2, private element: ElementRef, private router: Router, private storageSer: StorageSService,private alerteRoleService: AlerteRoleService) {
