...
export class DurationComponent implements OnInit {
  ...
  title = [
    "Table Portefeuille",
    "Table Portefeuille Islamique",
    "Table Portefeuille Leasing",
  ];
  dataTablePortefeuille: any = [
    {
      lable: "Total du portefeulle direct",
      value: [38.14, 37.89, 28.25, 32.52, 31.3],
    },
    {
    ...
    {
      lable:
        "Taux moyen des crédits dont l’échéance est moins de 1 an sans le découvert en compte ",
    ...
    {
      lable:
        "Part des engagements des crédits dont l’échéance est moins de 1 an sans le découvert en compte",
  ...
  dataTablePortefeuilleIslamique: any = [
    ...
    {
      lable: "Nombre des clients à engagements directs islamiques",
      value: [44, 40, 43, 39, 40],
    },
    {
      lable: "Nombre total des comptes à engagements directs islamiques",
    ...
    },
    {
      ...
      value: [0.26, 0.006, 0.054, 0.24, 0.48],
    },
  ];
  ...
  dataTablePortefeuilleLeasing: any = [
    ...
    {
      lable: "Nombre de clients à engagements directs",
      value: [337, 329, 330, 337, 331],
    },
    {
      lable: "Nombre des clients à engagements directs",
    ...
    {
      lable: "Total des créances courantes  ",
      value: [0.014, 0.01, 0.008, 0.012, 0.02],
    },
  ];
